...
public class Tower extends SpriteBase {
	...
	public void move() {
		...
		if( target != null)
		{
			...
			double targetAngle = Math.atan2(yDist, xDist) - Math.PI / 2; // -Math.PI / 2 because our sprite faces downwards
			...
			// normalize
			diff = MathUtils.normalRelativeAngleDeg( diff);
			...
			withinFiringRange = Math.abs( diff) < firingRangeLimitDeg;
