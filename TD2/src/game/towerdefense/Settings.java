...
public class Settings {
	...
	public static int TOWER_GRID_COLUMNS = 15;
	public static int TOWER_GRID_ROWS = 10;

	public static double CELL_WIDTH= SCENE_WIDTH/TOWER_GRID_COLUMNS;
	public static double CELL_HEIGHT= SCENE_HEIGHT/TOWER_GRID_ROWS;
